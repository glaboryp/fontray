...
const processFile = (file) => {
  ...
  success.value = 'Imagen cargada correctamente. ¡Haz clic en "Identificar fuente" para continuar!'
}
...
const identifyFont = async () => {
  ...
  try {
    ...
    error.value = 'Hubo un error al procesar la imagen. Por favor, inténtalo de nuevo.'
